...
const photos: Record<number, { src: string; alt: string }> = {
  ...
  6: { src: 'st-6.jpg', alt: 'Окно в стене из бруса' },
  7: { src: 'st-7.jpg', alt: 'Трубы и кабели по деревянным стойкам' },
  8: { src: 'st-8.jpg', alt: 'Шлифовка бруса перед покрытием маслом' },
